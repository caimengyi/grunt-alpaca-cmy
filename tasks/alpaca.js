...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('alpaca', 'alpaca is so cute', function () {
    ...
    this.files.forEach(function (file) {
      ...
      file.src.filter(function (filepath) {
        ...
        // Read file source.
        var originFlieContent = grunt.file.read(filepath),
            newFileContent = commentContent + grunt.util.normalizelf('\n') + originFlieContent;

        if(testExistRegexMap[who].test(originFlieContent)){
          return;
        }
